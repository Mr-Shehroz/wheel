            ...
            <section>
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row md:gap-1 gap-4">
                        <button className="relative overflow-hidden group bg-black text-white px-20 md:px-10 py-3 rounded-full md:rounded-br-none md:rounded-tr-none border-2 border-black transition duration-500">
                            <span className="relative z-10 group-hover:text-black transition duration-500">
                                Freelancers
                            </span>
                            <span className="absolute inset-0 bg-white scale-x-0 origin-right group-hover:scale-x-100 transition-transform duration-500 ease-out pointer-events-none z-0"></span>
                        </button>

                        <button className="relative overflow-hidden group bg-black text-white px-20 md:px-10 py-3 rounded-full md:rounded-bl-none md:rounded-tl-none border-2 border-black transition duration-500">
                            <span className="relative z-10 group-hover:text-black transition duration-500">
                                Companies
                            </span>
                            <span className="absolute inset-0 bg-white scale-x-0 origin-left group-hover:scale-x-100 transition-transform duration-500 ease-out pointer-events-none z-0"></span>
                        </button>
